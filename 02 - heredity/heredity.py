...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    probability = 1
    for person in people:
        # Determine number of genes for the person
        ...
        # Probability of gene given inheritance
        ...
        if mother is None and father is None:
            ...
            # Parental information available; calculate based on inheritance
            probs = {}
            ...
            if genes == 2:
                ...
                gene_prob = (
                    (probs[mother] * (1 - probs[father])) + 
                    ((1 - probs[mother]) * probs[father])
                )
            else:
